...
def script():
    robot = Schoolbus()
    robot.print_title("Dynamic Pedestrian")
    ...
    robot.drive_for(
        ...
        end_function_kwargs={"zone": "front", "min_dist": 0, "max_dist": 8.0},
        # duration=10,
    )
    ...
    robot.stop(
        ...
        duration_kwargs={"zone": "front", "min_dist": 0, "max_dist": 8.0},
    )
    ...
    robot.drive_for(
        ...
        angle=robot.lane_center,
        # end_function=robot.object_in_zone,
        # end_function_kwargs={"zone": "front", "min_dist": 0, "max_dist": 7.0},
        duration=10,
    )
    ...
    robot.drive_for(
        ...
        angle=robot.lane_center,
        end_function=robot.object_in_zone,
        end_function_kwargs={"zone": "front", "min_dist": 0, "max_dist": 2.2},
        # duration=10,
    )
